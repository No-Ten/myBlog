---
title: SpringMVC
data: 2021-11-13 0:20:20
index_img: /img/articleImages/spring.png
banner_img: /img/articleImages/spring.png
comment: 'valine'
category: framework
tages:
  - SpringMVC
...
![img](SpringMVC/1905053-20200331221325100-1165356814.png)
...
![img](SpringMVC/1905053-20200331221347503-978638377.png)
...
![img](SpringMVC/1905053-20200331221406483-639584230.png)
...
![img](SpringMVC/1905053-20200331222018441-1850931217.png)
...
![img](SpringMVC/1905053-20200331222037711-828417064.png)

SpringMVC的原理如下图所示：

当发起请求时被前置的控制器拦截到请求，根据请求参数生成代理请求，找到请求对应的实际控制器，控制器处理请求，创建数据模型，访问数据库，将模型响应给中心控制器，控制器使用模型与视图渲染视图结果，将结果返回给中心控制器，再将结果返回给请求者。

![img](SpringMVC/1905053-20200331222109176-906298972.png)

### SpringMVC执行原理

![img](SpringMVC/1905053-20200331222126131-219513987.png)
...
![image-20210731181900414](SpringMVC/image-20210731181900414.png)

 3.重启Tomcat 即可解决！

 4.没有将Controller类交给SpringIOC容器，注册bean！

 5.出现500的情况：web.xml中的注册DispatcherServlet中的<inin-param>中的<param-value>的classpath写漏，如下图

![image-20210731184323992](SpringMVC/image-20210731184323992.png)
...
3. 我们来测试请求查看下
   ...
   ![img](SpringMVC/1905053-20200331213217087-619232504.png)
...
4. 思考：使用路径变量的好处？
   ...
   - 通过路径变量的类型可以约束访问参数，如果类型不一样，则访问不到对应的请求方法，如这里访问是的路径是/commit/1/a，则路径与方法不匹配，而不会是参数转换失败。
     ...
     ![img](SpringMVC/1905053-20200401214609681-1237588624.png)
...
5. 我们来修改下对应的参数类型，再次测试
   ...
   ![img](SpringMVC/1905053-20200401214657561-1298821776.png)
...
![img](SpringMVC/1905053-20200401214714976-802588010.png)
...
![img](SpringMVC/1905053-20200401214737681-664600385.png)
...
![img](SpringMVC/1905053-20200331213251638-969968192.png)
...
![img](SpringMVC/1905053-20200401214504256-745544113.png)
...
![img](SpringMVC/1905053-20200402193540997-1854631524.png)
...
1. 修改tomcat配置文件 ： 设置编码！(conf-->server.xml)
...
- 启动Tomcat不成功的原因，可能是没有导lib包

![image-20210811192257482](SpringMVC/image-20210811192257482.png)



- 返回值类型写错

![image-20210811192336918](SpringMVC/image-20210811192336918.png)



- 找不到bean

  ![image-20210811192627057](SpringMVC/image-20210811192627057.png)

- 排错思路

  ![image-20210811192652810](SpringMVC/image-20210811192652810.png)



- 出现这个错误，可能是返回值类型写错

![image-20210811192746763](SpringMVC/image-20210811192746763.png)

![image-20210811192802314](SpringMVC/image-20210811192802314.png)

- 用了中文逗号

  ![image-20210811192859967](SpringMVC/image-20210811192859967.png)
...
![img](SpringMVC/1905053-20200331213612113-1624858159.png)
...
![img](SpringMVC/1905053-20200331213642133-500236017.png)
...
![img](SpringMVC/1905053-20200331213729633-854108693.png)
...
![image-20210811204452782](SpringMVC/image-20210811204452782.png)

- 输出数据没有在table标签内，且没对齐

![image-20210811204532578](SpringMVC/image-20210811204532578.png)+
...
![img](SpringMVC/1905053-20200331213841543-745577399.png)

# 16、SpringMVC的执行流程



![img](SpringMVC/1370903-20180827201021158-682489195.png)
